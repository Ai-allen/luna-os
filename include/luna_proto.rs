...
pub const LUNA_GATE_VALIDATE_NETWORK: u32 = 18;
pub const LUNA_GATE_VALIDATE_DEVICE: u32 = 19;
...
pub const LUNA_DATA_OBJECT_TYPE_LSON_RECORD: u32 = 0x4C53_4F52;
...
pub const LUNA_CAP_NETWORK_SEND: u64 = 0xA601;
pub const LUNA_CAP_NETWORK_RECV: u64 = 0xA602;
pub const LUNA_CAP_NETWORK_PAIR: u64 = 0xA603;
pub const LUNA_CAP_NETWORK_SESSION: u64 = 0xA604;
pub const LUNA_NETWORK_SEND_PACKET: u32 = 1;
pub const LUNA_NETWORK_RECV_PACKET: u32 = 2;
...
pub const LUNA_NETWORK_POLICY_RAW_PACKET: u64 = 1u64 << 0;
pub const LUNA_NETWORK_POLICY_DEGRADED: u64 = 1u64 << 1;
pub const LUNA_NETWORK_POLICY_OFFLINE: u64 = 1u64 << 2;
pub const LUNA_NETWORK_POLICY_SOFT_LOOP: u64 = 1u64 << 3;
pub const LUNA_NETWORK_POLICY_DEVICE_EXEC: u64 = 1u64 << 4;
pub const LUNA_DEVICE_POLICY_READ: u64 = 1u64 << 0;
pub const LUNA_DEVICE_POLICY_WRITE: u64 = 1u64 << 1;
pub const LUNA_DEVICE_POLICY_CONTROL: u64 = 1u64 << 2;
pub const LUNA_DEVICE_POLICY_UNSAFE_WRITE: u64 = 1u64 << 3;
pub const LUNA_DEVICE_POLICY_DEGRADED: u64 = 1u64 << 4;
pub const LUNA_DEVICE_POLICY_RECOVERY: u64 = 1u64 << 5;
pub const LUNA_DEVICE_POLICY_POLL: u64 = 1u64 << 6;
pub const LUNA_DEVICE_LIST: u32 = 1;
pub const LUNA_DEVICE_READ: u32 = 2;
pub const LUNA_DEVICE_WRITE: u32 = 3;
...
pub const LUNA_LANE_DRIVER_USB_HID_KEYBOARD: u32 = 21;
...
pub const LUNA_DRIVER_CONSEQUENCE_NONE: u32 = 0;
pub const LUNA_DRIVER_CONSEQUENCE_CONTINUE: u32 = 1;
pub const LUNA_DRIVER_CONSEQUENCE_DEGRADED_CONTINUE: u32 = 2;
pub const LUNA_DRIVER_CONSEQUENCE_FATAL_STOP: u32 = 3;
pub const LUNA_DRIVER_CONSEQUENCE_OBSERVER_ONLY: u32 = 4;
pub const LUNA_DRIVER_CONSEQUENCE_BIND_DENIED: u32 = 5;
pub const LUNA_DRIVER_BLOCKER_NONE: u32 = 0;
pub const LUNA_DRIVER_BLOCKER_STORAGE_RUNTIME_MISSING: u32 = 1u32 << 0;
pub const LUNA_DRIVER_BLOCKER_STORAGE_FIRMWARE_ONLY: u32 = 1u32 << 1;
pub const LUNA_DRIVER_BLOCKER_STORAGE_LEGACY_FALLBACK: u32 = 1u32 << 2;
pub const LUNA_DRIVER_BLOCKER_DISPLAY_TEXT_ONLY: u32 = 1u32 << 3;
pub const LUNA_DRIVER_BLOCKER_DISPLAY_FIRMWARE_ONLY: u32 = 1u32 << 4;
pub const LUNA_DRIVER_BLOCKER_INPUT_LEGACY_ONLY: u32 = 1u32 << 5;
pub const LUNA_DRIVER_BLOCKER_NETWORK_LOOP_ONLY: u32 = 1u32 << 6;
pub const LUNA_DRIVER_RECOVERY_NONE: u32 = 0;
pub const LUNA_DRIVER_RECOVERY_CONTINUE: u32 = 1;
pub const LUNA_DRIVER_RECOVERY_RUNTIME_REBIND: u32 = 2;
pub const LUNA_DRIVER_RECOVERY_LEGACY_FALLBACK: u32 = 3;
pub const LUNA_DRIVER_RECOVERY_REENTER_FIRMWARE: u32 = 4;
pub const LUNA_DRIVER_RECOVERY_ENTER_RECOVERY: u32 = 5;
pub const LUNA_DRIVER_ACTION_NONE: u32 = 0;
pub const LUNA_DRIVER_ACTION_STORAGE_FALLBACK_FAMILY: u32 = 1u32 << 0;
pub const LUNA_DRIVER_ACTION_STORAGE_READONLY: u32 = 1u32 << 1;
pub const LUNA_DRIVER_ACTION_STORAGE_RESCAN: u32 = 1u32 << 2;
pub const LUNA_DRIVER_ACTION_STORAGE_RECOVERY_BOOT: u32 = 1u32 << 3;
pub const LUNA_DRIVER_ACTION_STORAGE_DISABLE_UNSAFE_WRITE: u32 = 1u32 << 4;
pub const LUNA_DRIVER_ACTION_INPUT_MINIMAL: u32 = 1u32 << 5;
pub const LUNA_DRIVER_ACTION_INPUT_OPERATOR_RECOVERY: u32 = 1u32 << 6;
pub const LUNA_DRIVER_ACTION_DISPLAY_CONSOLE_FALLBACK: u32 = 1u32 << 7;
pub const LUNA_DRIVER_ACTION_DISPLAY_FRAMEBUFFER_DISABLED: u32 = 1u32 << 8;
pub const LUNA_DRIVER_ACTION_NETWORK_OFFLINE: u32 = 1u32 << 9;
pub const LUNA_DRIVER_ACTION_NETWORK_SOFT_LOOP: u32 = 1u32 << 10;
pub const LUNA_DRIVER_SELECT_NONE: u32 = 0;
pub const LUNA_DRIVER_SELECT_FWBLK_SOURCE: u32 = 1;
pub const LUNA_DRIVER_SELECT_FWBLK_TARGET: u32 = 2;
pub const LUNA_DRIVER_SELECT_AHCI_RUNTIME: u32 = 3;
pub const LUNA_DRIVER_SELECT_PIIX_IDE: u32 = 4;
pub const LUNA_DRIVER_SELECT_ATA_FALLBACK: u32 = 5;
pub const LUNA_DRIVER_SELECT_GOP_FRAMEBUFFER: u32 = 6;
pub const LUNA_DRIVER_SELECT_STD_VGA_FRAMEBUFFER: u32 = 7;
pub const LUNA_DRIVER_SELECT_STD_VGA_TEXT: u32 = 8;
pub const LUNA_DRIVER_SELECT_TEXT_FALLBACK: u32 = 9;
pub const LUNA_DRIVER_SELECT_VIRTIO_KEYBOARD: u32 = 10;
pub const LUNA_DRIVER_SELECT_I8042: u32 = 11;
pub const LUNA_DRIVER_SELECT_LEGACY_KEYBOARD: u32 = 12;
pub const LUNA_DRIVER_SELECT_E1000_PRESENT: u32 = 13;
pub const LUNA_DRIVER_SELECT_E1000_READY: u32 = 14;
pub const LUNA_DRIVER_SELECT_E1000E_PRESENT: u32 = 15;
pub const LUNA_DRIVER_SELECT_E1000E_READY: u32 = 16;
pub const LUNA_DRIVER_SELECT_SOFT_LOOP: u32 = 17;
pub const LUNA_DRIVER_SELECT_ICH9_PCI: u32 = 18;
pub const LUNA_DRIVER_SELECT_PIIX_PCI: u32 = 19;
pub const LUNA_DRIVER_SELECT_LEGACY_UART: u32 = 20;
pub const LUNA_DRIVER_EVIDENCE_PCI_PRESENT: u32 = 1u32 << 0;
pub const LUNA_DRIVER_EVIDENCE_FWBLK_SOURCE: u32 = 1u32 << 1;
pub const LUNA_DRIVER_EVIDENCE_FWBLK_TARGET: u32 = 1u32 << 2;
pub const LUNA_DRIVER_EVIDENCE_FWBLK_TARGET_SEPARATE: u32 = 1u32 << 3;
pub const LUNA_DRIVER_EVIDENCE_FRAMEBUFFER: u32 = 1u32 << 4;
pub const LUNA_DRIVER_EVIDENCE_AHCI_READY: u32 = 1u32 << 5;
pub const LUNA_DRIVER_EVIDENCE_VIRTIO_READY: u32 = 1u32 << 6;
pub const LUNA_DRIVER_EVIDENCE_PS2_PRESENT: u32 = 1u32 << 7;
pub const LUNA_DRIVER_EVIDENCE_NET_READY: u32 = 1u32 << 8;
pub const LUNA_DRIVER_EVIDENCE_INSTALL_MODE: u32 = 1u32 << 9;
pub const LUNA_DRIVER_EVIDENCE_RECOVERY_MODE: u32 = 1u32 << 10;
pub const LUNA_DRIVER_EVIDENCE_USB_INPUT_CONTROLLER: u32 = 1u32 << 11;
...
pub const LUNA_DRIVER_LIFE_STORAGE_FIRMWARE_ONLY: u64 = 1u64 << 5;
pub const LUNA_DRIVER_LIFE_STORAGE_LEGACY_FALLBACK: u64 = 1u64 << 6;
pub const LUNA_DRIVER_LIFE_DISPLAY_TEXT_ONLY: u64 = 1u64 << 7;
pub const LUNA_DRIVER_LIFE_DISPLAY_FIRMWARE_ONLY: u64 = 1u64 << 8;
pub const LUNA_DRIVER_LIFE_INPUT_LEGACY_ONLY: u64 = 1u64 << 9;
pub const LUNA_DRIVER_LIFE_NETWORK_LOOP_ONLY: u64 = 1u64 << 10;
pub const LUNA_DRIVER_LIFE_RECOVERY_REQUIRED: u64 = 1u64 << 11;
pub const LUNA_DRIVER_LIFE_RUNTIME_REBIND: u64 = 1u64 << 12;
pub const LUNA_DRIVER_LIFE_LEGACY_RECOVERY: u64 = 1u64 << 13;
pub const LUNA_DRIVER_POLICY_BLOCKER_MASK: u32 = 0x0000_FFFF;
pub const LUNA_DRIVER_POLICY_CLASS_SHIFT: u32 = 16;
pub const LUNA_DRIVER_ACTION_LIFECYCLE_SHIFT: u32 = 32;
...
pub struct LunaDriverBindRecord {
    ...
    pub driver_family: u32,
    pub state_flags: u32,
    pub approval_space: u32,
    pub selection_basis: u32,
    pub evidence_flags: u32,
    pub volume_state: u32,
    pub system_mode: u32,
    pub lifecycle_consequence: u32,
    pub firmware_path: u32,
    pub firmware_flags: u32,
    pub blocker_flags: u32,
    pub recovery_hint: u32,
    pub lifecycle_flags: u64,
    pub firmware_storage_status: u64,
    pub firmware_display_status: u64,
    ...
    pub pci_subclass: u8,
    pub pci_prog_if: u8,
    pub pci_header_type: u8,
    pub reserved1: [u8; 1],
    pub recovery_action_flags: u32,
    pub bound_at: u64,
