...
enum luna_driver_lifecycle_consequence {
    LUNA_DRIVER_CONSEQUENCE_NONE = 0,
    LUNA_DRIVER_CONSEQUENCE_CONTINUE = 1,
    LUNA_DRIVER_CONSEQUENCE_DEGRADED_CONTINUE = 2,
    LUNA_DRIVER_CONSEQUENCE_FATAL_STOP = 3,
    LUNA_DRIVER_CONSEQUENCE_OBSERVER_ONLY = 4,
    LUNA_DRIVER_CONSEQUENCE_BIND_DENIED = 5,
};

enum luna_driver_blocker_flag {
    LUNA_DRIVER_BLOCKER_NONE = 0,
    LUNA_DRIVER_BLOCKER_STORAGE_RUNTIME_MISSING = 1u << 0,
    LUNA_DRIVER_BLOCKER_STORAGE_FIRMWARE_ONLY = 1u << 1,
    LUNA_DRIVER_BLOCKER_STORAGE_LEGACY_FALLBACK = 1u << 2,
    LUNA_DRIVER_BLOCKER_DISPLAY_TEXT_ONLY = 1u << 3,
    LUNA_DRIVER_BLOCKER_DISPLAY_FIRMWARE_ONLY = 1u << 4,
    LUNA_DRIVER_BLOCKER_INPUT_LEGACY_ONLY = 1u << 5,
    LUNA_DRIVER_BLOCKER_NETWORK_LOOP_ONLY = 1u << 6,
};

enum luna_driver_recovery_hint {
    LUNA_DRIVER_RECOVERY_NONE = 0,
    LUNA_DRIVER_RECOVERY_CONTINUE = 1,
    LUNA_DRIVER_RECOVERY_RUNTIME_REBIND = 2,
    LUNA_DRIVER_RECOVERY_LEGACY_FALLBACK = 3,
    LUNA_DRIVER_RECOVERY_REENTER_FIRMWARE = 4,
    LUNA_DRIVER_RECOVERY_ENTER_RECOVERY = 5,
};

enum luna_driver_recovery_action_flag {
    LUNA_DRIVER_ACTION_NONE = 0,
    LUNA_DRIVER_ACTION_STORAGE_FALLBACK_FAMILY = 1u << 0,
    LUNA_DRIVER_ACTION_STORAGE_READONLY = 1u << 1,
    LUNA_DRIVER_ACTION_STORAGE_RESCAN = 1u << 2,
    LUNA_DRIVER_ACTION_STORAGE_RECOVERY_BOOT = 1u << 3,
    LUNA_DRIVER_ACTION_STORAGE_DISABLE_UNSAFE_WRITE = 1u << 4,
    LUNA_DRIVER_ACTION_INPUT_MINIMAL = 1u << 5,
    LUNA_DRIVER_ACTION_INPUT_OPERATOR_RECOVERY = 1u << 6,
    LUNA_DRIVER_ACTION_DISPLAY_CONSOLE_FALLBACK = 1u << 7,
    LUNA_DRIVER_ACTION_DISPLAY_FRAMEBUFFER_DISABLED = 1u << 8,
    LUNA_DRIVER_ACTION_NETWORK_OFFLINE = 1u << 9,
    LUNA_DRIVER_ACTION_NETWORK_SOFT_LOOP = 1u << 10,
};

enum luna_driver_selection_basis {
    LUNA_DRIVER_SELECT_NONE = 0,
    LUNA_DRIVER_SELECT_FWBLK_SOURCE = 1,
    LUNA_DRIVER_SELECT_FWBLK_TARGET = 2,
    LUNA_DRIVER_SELECT_AHCI_RUNTIME = 3,
    LUNA_DRIVER_SELECT_PIIX_IDE = 4,
    LUNA_DRIVER_SELECT_ATA_FALLBACK = 5,
    LUNA_DRIVER_SELECT_GOP_FRAMEBUFFER = 6,
    LUNA_DRIVER_SELECT_STD_VGA_FRAMEBUFFER = 7,
    LUNA_DRIVER_SELECT_STD_VGA_TEXT = 8,
    LUNA_DRIVER_SELECT_TEXT_FALLBACK = 9,
    LUNA_DRIVER_SELECT_VIRTIO_KEYBOARD = 10,
    LUNA_DRIVER_SELECT_I8042 = 11,
    LUNA_DRIVER_SELECT_LEGACY_KEYBOARD = 12,
    LUNA_DRIVER_SELECT_E1000_PRESENT = 13,
    LUNA_DRIVER_SELECT_E1000_READY = 14,
    LUNA_DRIVER_SELECT_E1000E_PRESENT = 15,
    LUNA_DRIVER_SELECT_E1000E_READY = 16,
    LUNA_DRIVER_SELECT_SOFT_LOOP = 17,
    LUNA_DRIVER_SELECT_ICH9_PCI = 18,
    LUNA_DRIVER_SELECT_PIIX_PCI = 19,
    LUNA_DRIVER_SELECT_LEGACY_UART = 20,
};

enum luna_driver_evidence_flag {
    LUNA_DRIVER_EVIDENCE_PCI_PRESENT = 1u << 0,
    LUNA_DRIVER_EVIDENCE_FWBLK_SOURCE = 1u << 1,
    LUNA_DRIVER_EVIDENCE_FWBLK_TARGET = 1u << 2,
    LUNA_DRIVER_EVIDENCE_FWBLK_TARGET_SEPARATE = 1u << 3,
    LUNA_DRIVER_EVIDENCE_FRAMEBUFFER = 1u << 4,
    LUNA_DRIVER_EVIDENCE_AHCI_READY = 1u << 5,
    LUNA_DRIVER_EVIDENCE_VIRTIO_READY = 1u << 6,
    LUNA_DRIVER_EVIDENCE_PS2_PRESENT = 1u << 7,
...
enum luna_driver_lifecycle_flag {
    ...
    LUNA_DRIVER_LIFE_STORAGE_FIRMWARE_ONLY = 1u << 5,
    LUNA_DRIVER_LIFE_STORAGE_LEGACY_FALLBACK = 1u << 6,
    LUNA_DRIVER_LIFE_DISPLAY_TEXT_ONLY = 1u << 7,
    LUNA_DRIVER_LIFE_DISPLAY_FIRMWARE_ONLY = 1u << 8,
    LUNA_DRIVER_LIFE_INPUT_LEGACY_ONLY = 1u << 9,
    LUNA_DRIVER_LIFE_NETWORK_LOOP_ONLY = 1u << 10,
    LUNA_DRIVER_LIFE_RECOVERY_REQUIRED = 1u << 11,
    LUNA_DRIVER_LIFE_RUNTIME_REBIND = 1u << 12,
    LUNA_DRIVER_LIFE_LEGACY_RECOVERY = 1u << 13,
};

#define LUNA_DRIVER_POLICY_BLOCKER_MASK 0x0000FFFFu
#define LUNA_DRIVER_POLICY_CLASS_SHIFT 16u
#define LUNA_DRIVER_ACTION_LIFECYCLE_SHIFT 32u
...
#define LUNA_DATA_OBJECT_TYPE_LSON_RECORD 0x4C534F52u
