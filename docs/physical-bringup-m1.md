...
- a placeholder `evidence-manifest.txt`
...
- `evidence-manifest.txt` must be generated by finalization and must hash the
  captured log, `operator-notes.txt`, and `machine.txt`
